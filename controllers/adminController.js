...
exports.getAllBatches = async (req, res) => {
  try {
    const [rows] = await db.execute("SELECT * FROM batches ORDER BY id DESC");
...
exports.fetchBasicOldClientLeadsForMsTeams = async (req, res) => {
  try {
    ...
    let whereClause = `
      ...
      AND a.old_basic_ms_clients_msdetails = 'pending'
      AND (a.batch_type = 'basic' OR a.batch_type = 'both')
    `;
